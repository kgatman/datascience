...
prop.table(table(test_income$income))
...
# we will start by tuning the hyperparameter (max_depth which is the maximum depth of the final decision tree).
